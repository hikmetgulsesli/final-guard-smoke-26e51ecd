...
- Final Guard Smoke turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a tiny single-page utility called Final Guard Smoke. It should show three compact status tiles, one Refresh button, a small activity list, and a last-updated timestamp. Keep it simple and static; use Vite React if web stack is selected.
...
- Status Utility - Final Guard Smoke

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Status Utility - Final Guard Smoke
